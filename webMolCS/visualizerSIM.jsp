...
<script>
	...
	<script>
		...
		//Index of point which contains query
		var qIndex;

		//set tab name
                document.getElementById("title1").text=fp+" SIM map";
		...
		function init() {
			...
			this.PC1=pc1+"";
                        ...
                        gui.add(effectController, 'MQNMaps', ['FP-Rank','List-Rank', 'ActualVals', 'Single color']).onChange(gui_setMap).name(fp+"-SIM Map colors");
