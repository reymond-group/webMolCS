 ...
 * @author mahendra
 */
public class getImageForAVGMol3 implements ImageObserver {
    ...
    public static void main(String args[]) throws FileNotFoundException, IOException {
        ...
        while ((str = br.readLine()) != null) {
            ...
            getImageForAVGMol3 image = new getImageForAVGMol3(smi, control + "", "mols");
            control++;
            Molecule mol = new MolHandler(smi).getMolecule();
        }
    }

    public getImageForAVGMol3(String smi, String fileName, String folder) throws MolFormatException, IOException {
...
//        mdoc.setBondSetRGB(0, green.getRGB());
        ...
        Image img = (Image) mol.toObject("image:w200,h200,#000000,setcolors:b0:#ffffff,wireThickness0.1,atsiz0.6");
