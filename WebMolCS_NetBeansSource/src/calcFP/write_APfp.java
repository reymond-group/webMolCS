...
//==============================================================================
        ...
        while ((str = br.readLine()) != null) {
            ...
            FP02_AllAtomTopoFP fp = new FP02_AllAtomTopoFP(pm.mol);
            String apfp = fp.createFP();
            if (apfp == null) {
                continue;
            }
            ...
            bw.write(smi + " " + sarray[1] + " " + sarray[2] + " " + fp.arrayToString(fp.shapeFPInt_20, ";") + "\n");
            counter++;
            if (counter % 10000 == 0) {
