	...
	<script>
		...
		function init() {
			...
			for (var i = 0; i < splitCoord.length; i++ ) {
				...
				arr2DCoord.push(new Uint16Array([parseInt(xyz[0]), parseInt(xyz[1]), parseInt(xyz[2])]));
			...
			//Do the tree calculation
			var data=e.data;
			for(var i=0;i<data.length;i++)
                        {
				var pntIdx1=parseInt(data[i][0]);
                                var pntIdx2=parseInt(data[i][1]);
			...
			console.log(e.data);
			console.log(arr2DCoord);

      			}, false);

			worker.postMessage(arr2DCoord);
			//==================================================================================
