    ...
    public static void main(String args[]) throws FileNotFoundException, IOException {
        ...
        while ((str = brDB.readLine()) != null) {
            ...
            for (int a = 0; a < refFPs.size(); a++) {
                ...
                double d = getMHPFPTanimoto(fPs, refFPs.get(a));
                dist = dist + df.format(d) + ";";
            }
            //==============================================================
            double maxTani = Double.MIN_VALUE;
            for (int a = 0; a < allActivesFPs.size(); a++) {
                double d = getMHPFPTanimoto(fPs, allActivesFPs.get(a));

                if (d > maxTani) {
                    maxTani = d;
                }
            }
            bw.write(sarray[0] + " " + sarray[1] + " " + dist + " " + sarray[2] + ";" + maxTani + "\n");
            //==================================================================
        }
...
//==============================================================================
    ...
    static double getMHPFPTanimoto(double fp1[], double fp2[]) {
