...
import makeFP.FP02_AllAtomTopoFP;
import makeFP.FP04_MQN;
import makeFP.FP06_sFP;
import makeFP.FP07_ECFP4;
...
public class write_AllInOne {
    ...
    public static void main(String[] args) throws IOException, MDGeneratorException {
        ...
        while ((s = br1.readLine()) != null) {
            ...
            write_AllInOne make = new write_AllInOne();
            ...
            //SMIfp
            String smIfp = make.getSMIfp(pm.mol.toFormat("smiles:q0-H"));
            ...
            FP04_MQN makeMQN = new FP04_MQN();
            String mqn = makeMQN.calculateFingerprint(pm.mol);
            ...
            String Xfp = fp.arrayToString(fp.shapeFPInt, ";");
            ...
            //Now Calculate ECfp4
            FP07_ECFP4 ecfp = new FP07_ECFP4();
            String ecfp4 = ecfp.make_StringECFP(pm.mol.toFormat("smiles:q0-H"));
            if (ecfp4 == null) {
                continue;
            }

            //Calculate APfp
            FP02_AllAtomTopoFP fp7 = new FP02_AllAtomTopoFP(pm.mol);
            String APfp = fp7.createFP();
            if (APfp == null) {
                continue;
            }

            APfp = fp.arrayToString(fp7.shapeFPInt_20, ";");

            smi = pm.mol.toFormat("smiles:q0-H");
            //write unique pH adjusted smiles (+ eventually tag) + resulting SMIfp
            bw1.write(smi + " " + sarr[1] + " " + sarr[2] + " " + Xfp + " " + mqn + " " + smIfp + " " + sfp + " " + ecfp4 + " " + APfp + "\n");
            okMolCount++;
